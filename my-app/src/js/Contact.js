    ...
    return (
      <div className="Contact">
        ...
        <div className="Icon-container">
          ...
          <div className="Icon-item"><a href="https://github.com/maxbrown2015?tab=repositories" className="Icon-item"><i className="fa fa-github fa-2x" aria-hidden="true"></i></a></div>
